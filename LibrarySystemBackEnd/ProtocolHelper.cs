		...
		public Protocol GetProtocol() {
			...
			switch (mode) {
				...
				case RequestMode.AdminAddBook: {
					XmlNode booknode = root.SelectSingleNode("book");
					pro.NowBook = new ClassBook(booknode.Attributes["bookisbn"].Value);
					pro.NowBook.BookAuthor = booknode.Attributes["author"].Value;
					pro.NowBook.BookName = booknode.Attributes["bookname"].Value;
					pro.NowBook.BookIsbn = booknode.Attributes["bookisbn"].Value;
					pro.NowBook.BookAmount = Convert.ToInt32(booknode.Attributes["bookamount"].Value);
					pro.NowBook.BookPublishTime = Convert.ToDateTime(booknode.Attributes["publishtime"].Value);
					pro.NowBook.BookLable1 = booknode.Attributes["booklabel1"].Value;
					pro.NowBook.BookLable2 = booknode.Attributes["booklabel2"].Value;
					pro.NowBook.BookLable3 = booknode.Attributes["booklabel3"].Value;
					pro.NowBook.BookPublisher = booknode.Attributes["publisher"].Value;
					pro.NowBook.BookIntroduction = booknode.Attributes["introduction"].Value;
